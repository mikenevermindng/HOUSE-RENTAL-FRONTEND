            ...
            <div className="service-container">
                ...
                <div className="left-services">
                    ...
                    <div className="service">
                        <img src={ElecIcon} alt="light icon" />
                    ...
                    <div className="service">
                        <img src={KitIcon} alt="kitchen icon" />
                        <div className="service-info">
                    ...
                    <div className="service">
                        <img src={ACIcon} alt="air conditioner icon" />
                        <div className="service-info">
                ...
                <div className="right-services">
                    ...
                    <div className="service">
                        <img src={BalconyIcon} alt="balcony icon" />
                        <div className="service-info">
                    ...
                    <div className="service">
                        <img src={WashIcon} alt="washing machine icon" />
                        <div className="service-info">
                    ...
                    <div className="service">
                        <img src={DrobeIcon} alt="wardrobe icon" />
                        <div className="service-info">
